            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                    ...
                    <div className="lg:w-1/2 text-right space-y-6">
                        <h1 className="text-4xl font-amiri lg:text-6xl font-bold text-[#04261B]">
                            صَوت الإيمان
                        ...
                        <p className="text-xl font-tajawal  lg:text-4xl text-[#04261B] leading-10">
                            مرحباً بك في مكان نذكرك
                            <br />
                            بالله... استمع ، اذكر ،واجتمع
                            <br />
                            مع القرآن والأذكار بصوت
                            <br />
                            القارىء "محمد بربه"
                        </p>
                        <button className="bg-[#004B40] font-tajawal text-white px-8 py-3 rounded-md hover:bg-[#003830] transition-colors">
                            ابدأ الاستماع الآن
                        </button>
                    </div>
                    ...
                    <div className="lg:w-1/2 relative">
                        <div className="relative w-full aspect-[3/4] max-w-lg mx-auto">
                            ...
                            <div
                                ...
                                style={{
                                    backgroundImage: "url('/assets/img/mosque.png')",
